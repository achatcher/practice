<template>
  <div class="page-view">
    ...
    <div class="page-header">
      ...
      <p class="page-subtitle">Spas, salons & wellness near you</p>
    </div>
    ...
    <main class="svc-content">
      ...
      <section class="svc-results-section">
        <div v-if="filteredBusinesses.length > 0" class="pulse-list">
          <div
          ...
          >
            <div class="card-inner">
              <div class="image-box">
                <img :src="business.image" :alt="business.name" @error="handleImageError" />
              </div>
        ...
        <div v-else class="no-events">
          <p class="no-events-text">
            {{ searchQuery ? `No results for "${searchQuery}"` : activeSubcat ? `No ${activeSubcat} listings yet.` : 'No services listed yet.' }}
          </p>
        </div>
      </section>
    </main>
...
const allBusinesses = computed(() => businessStore.getBusinessesByCategory('services'))
